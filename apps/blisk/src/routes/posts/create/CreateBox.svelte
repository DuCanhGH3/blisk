  ...
  >
    <div class="flex flex-1 flex-row items-center justify-stretch gap-2">
      ...
      <Input
        ...
        errorText={$page.form?.validationError?.title}
        required
      />
    </div>
    <Input
      ...
      errorText={$page.form?.validationError?.book}
      required
    />
    <Textarea
      name="content"
    ...
    <div class="flex flex-row gap-2">
      <FilePicker
        ...
        errorText={$page.form?.validationError?.images}
      />
    ...
    {#if $page.form?.error}
      <p class="text-error-light dark:text-error-dark" role="alert">{$page.form.error}</p>
    {/if}
  </form>
</div>
