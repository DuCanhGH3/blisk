<script lang="ts">
  ...
  const { ...props }: Omit<SVGAttributes<SVGElement>, "width" | "height" | "viewBox"> = $props();
</script>

<svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 16 16" fill="none" {...props}>
