<svg xmlns="http://www.w3.org/2000/svg" class="sr-only">
  <defs>
    ...
    <linearGradient id="haha-mouth" x1="8" x2="8" y1="7" y2="14" gradientUnits="userSpaceOnUse">
    ...
    <symbol id="like-emoji" viewBox="0 0 16 16" fill="none">
      <path fill="url(#like-gradient)" d="M8 0a8 8 0 1 0 0 16A8 8 0 0 0 8 0Z" />
      <path
        class="animate-[like_1.5s_ease-out_0.5s_infinite]"
        fill="#fff"
    ...
    <symbol id="heart-emoji" viewBox="0 0 16 16" fill="none">
      <path fill="url(#heart-gradient)" d="M8 0a8 8 0 1 0 0 16A8 8 0 0 0 8 0Z" />
      <path
        class="animate-[heart_1.5s_ease-out_0.5s_infinite]"
        fill="#fff"
    ...
    <symbol id="haha-emoji" viewBox="0 0 16 16" fill="none">
      <path fill="url(#face-gradient)" d="M16 8A8 8 0 1 1-.001 8 8 8 0 0 1 16 8" />
      <g class="animate-haha-mouth">
        <path fill="url(#haha-mouth)" d="M3 8.008C3 10.023 4.006 14 8 14c3.993 0 5-3.977 5-5.992C13 7.849 11.39 7 8 7c-3.39 0-5 .849-5 1.008Z" />
        <path
          fill="url(#haha-tongue)"
          d="M4.541 12.5c.804.995 1.907 1.5 3.469 1.5 1.563 0 2.655-.505 3.459-1.5-.551-.588-1.599-1.5-3.459-1.5s-2.917.912-3.469 1.5Z"
        />
      </g>
      <path
        fill="#2A3755"
        class="animate-haha-eyes"
