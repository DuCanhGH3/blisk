...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="none" {...props}>
  ...
  <g class={clsx(animatable && "animate-haha-mouth")}>
    <path fill="url(#face-mouth)" d="M3 8.008C3 10.023 4.006 14 8 14c3.993 0 5-3.977 5-5.992C13 7.849 11.39 7 8 7c-3.39 0-5 .849-5 1.008Z" />
    <path
  ...
  <path
    fill="#2A3755"
    class={clsx(animatable && "animate-haha-eyes")}
