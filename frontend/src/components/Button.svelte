...
<svelte:element
  this={as}
  class={clsx(
    "transition-colors-opacity min-w-max rounded-md px-5 py-2.5 flex items-center justify-center text-sm font-medium duration-100",
    "focus:outline-hidden focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800",
