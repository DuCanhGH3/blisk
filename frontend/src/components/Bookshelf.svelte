...
<div class="bg-wood dark:bg-dark-wood bg-wood-500 dark:bg-wood-950 h-fit w-full">
  <ul
    class={clsx(
      ...
      "after:bg-wood after:bg-wood-500 dark:after:bg-wood-950 dark:after:bg-dark-wood after:h-5 after:w-[calc(100%+2*var(--depth))]",
    ...
    {#each books as book}
      <li
        class={clsx(
          ...
          "before:border-t-0! before:absolute before:bottom-0 before:[border-width:var(--depth)]",
          "after:bg-wood dark:after:bg-dark-wood after:bg-wood-500 dark:after:bg-wood-950 after:shadow-[5px_8px_20px_-2px_rgb(0_0_0/60%)]",
